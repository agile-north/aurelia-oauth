...
gulp.task("build-html-ts", function () {
    return gulp.src(paths.html).pipe(gulp.dest(paths.output + "ts"));
});

gulp.task("build-ts", ["build-html-ts"], function () {
    return gulp.src(paths.source).pipe(gulp.dest(paths.output + "ts"));
});

gulp.task("build-html-es6", function () {
    return gulp.src(paths.html).pipe(gulp.dest(paths.output + "es6"));
});
...
gulp.task("build-html-commonjs", function () {
    return gulp.src(paths.html).pipe(gulp.dest(paths.output + "commonjs"));
});
...
gulp.task("build-html-amd", function () {
    return gulp.src(paths.html).pipe(gulp.dest(paths.output + "amd"));
});
...
gulp.task("build-html-system", function () {
    return gulp.src(paths.html).pipe(gulp.dest(paths.output + "system"));
});
...
gulp.task("build-nolint", function (callback) {
    return runSequence(
        "clean",
        [
            "build-ts",
